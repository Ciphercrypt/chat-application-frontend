    ...
    <div className="flex flex-col w-[480px] h-full bg-[#202c33]" style={{borderRight: "1px solid rgba(134,150,160,0.15)"}}>
      <div className="flex items-center justify-between w-full px-4">
        ...
        <div className="flex gap-2">
          <div className="flex cursor-pointer w-10 h-10 items-center justify-center" onClick={() => setshowinvite(!showinvite)}>
          ...
          {/* <NotificationPanel /> */}
          <div className="flex cursor-pointer w-10 h-10 items-center justify-center" onClick={() => setshowprofile(!showprofile)}>
            <svg viewBox="0 0 24 24" width="24" height="24" className="text-[#AEBAC1]">
      ...
      <div className="flex bg-[#111b21] w-full h-max px-3 py-2">
        <div className="relative w-[95%] h-max">
          ...
          <div className="">
            <input className="w-[96%] h-9 rounded-lg bg-[#202c33] text-white text-sm px-10" placeholder="Search or start a new conversation" value={search} onChange={e => setSearch(e.target.value)} />
          </div>
        </div>
